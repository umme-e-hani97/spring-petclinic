# Spring PetClinic Sample Application [![Java CI with Maven](https://github.com/umme-e-hani97/spring-petclinic/actions/workflows/maven.yml/badge.svg)](https://github.com/umme-e-hani97/spring-petclinic/actions/workflows/maven.yml)
